...
class TestHostServiceLivenessProbe:
    ...
    def test_probe_reports_missing_socket(self, monkeypatch, tmp_path):
        """Loopholes (e.g. host-processes) ARE per-jail and DO have real
        sockets — the probe reports a missing socket as a failure."""
        from unittest.mock import MagicMock as _MM
